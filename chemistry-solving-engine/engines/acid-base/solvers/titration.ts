...
export function solveTitration(input: Record<string, unknown>) {
...
export function solveBufferOperation(input: Record<string, unknown>) {
  const bufferType = oneOf(input.bufferType, ["acid", "base"] as const, "input.bufferType");
