...
check("直接 AsciiMath 偵測", "isDisplayAsciiMath" in renderer and "DISPLAY_RE" in renderer and "P_(H_2O)" in core)
...
check("提示詞改用 AsciiMath", "ASCIIMATH_OUTPUT_RULES" in core and "所有公式使用 AsciiMath" in core and "中文說明寫 paragraph" in core)
